...
from main.views import TestnetOnboardView
...
schema_view = get_schema_view(
   ...
   public=True,
   url="https://backend.digidrops.xyz/api/v1/",
...
urlpatterns = [
    ...
    path('api/testnet/onboard/', TestnetOnboardView.as_view(), name='testnet-onboard-direct'),
